# Learning Graph for AP Computer Science (Python Version)
...
- Foundational concepts: 1 entry point (Computer Science)
...
create 15 categories for our concepts and then place each concept
into a single primary classifier.

- A concept classifier taxonomy with 15 categories
- Category organization - foundational elements first, advanced Python last
- Balanced categories (2% - 20% each)
