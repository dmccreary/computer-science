...
| 3 | MicroSims | 121 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 0 / 20 | Recommended | Chapters with a quiz.md (0 questions total) |
...
| 8 | FAQs | 45 | Recommended | Questions in faq.md |
| 9 | Words | 138,080 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 121 | 121 | H4 headers starting with '#### Diagram:' |
| Equations | 5 | 5 | LaTeX expressions (inline and display) |
| Total Words | 138,080 | 98,837 | Words in markdown files |
| Links | 788 | 200 | Hyperlinks in markdown format |
| Equivalent Pages | 643 | 486 | Estimated pages (250 words/page + visuals) |
